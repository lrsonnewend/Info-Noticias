...
@WebServlet(urlPatterns = { "/noticiasLogin" })
public class NoticiaLoginController extends HttpServlet{
    @Override
    public void doGet(HttpServletRequest req, HttpServletResponse res){
        ...
        try{
            ...
            req.getRequestDispatcher("/jsp/noticiasLogin.jsp").forward(req, res);
        }catch(Exception e){
